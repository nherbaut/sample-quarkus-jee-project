...
public class ETicket {
    fr.pantheonsorbonne.ufr27.miage.dto.ticket.TicketType type;
    double vendorFee;
    double fee;
    String email;
    String fname;
    ...
    public ETicket(fr.pantheonsorbonne.ufr27.miage.dto.ticket.TicketType type, double vendorFee, double fee, String email, String fname, String lname, int transitionalTicketId) {
        this.type = type;
    ...
    public fr.pantheonsorbonne.ufr27.miage.dto.ticket.TicketType getType() {
        return type;
    }

    public void setType(fr.pantheonsorbonne.ufr27.miage.dto.ticket.TicketType type) {
        this.type = type;
    }
